...
Summary:	SNG to PNG compiler/decompiler
Name:		%{name}
Version:	%{version}
Release:	%{release}
Serial:		%{serial}
...
%changelog
* Mon Dec 29 2003 Eric S. Raymond <esr@thyrsus.com>
- See the NEWS file for the project history.
